    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <p class="mb-5">IT graduate with passion to begin pursuing a lifelong
            ...
            through to achieve goal of attaining a role as a Front-End web developer. <br><br>Work well in a
            team without supervision and excel within fast-paced and challenging
            working environments.</p>
          <ul class="list-inline list-social-icons mb-0">
            <li class="list-inline-item">
              <a href="https://www.linkedin.com/in/madangurung">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">City University London</h3>
              <div class="subheading mb-3">Information System Technology</div>
              <p>PG Certificate</p>
            </div>
          ...
          <div class="resume-item d-flex flex-column flex-md-row">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">University of Hertfordshire</h3>
          ...
          <div class="resume-item d-flex flex-column flex-md-row">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">Reading College</h3>
              <p>Further A Levels</p>
            </div>
            <div class="resume-date text-md-right">
          ...
          <div class="resume-item d-flex flex-column flex-md-row">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">Highdown and Sixth form centre</h3>
              <p>A Levels</p>
            </div>
            <div class="resume-date text-md-right">
          ...
          <div class="resume-item d-flex flex-column flex-md-row">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">Prospect College of Technology</h3>
              <p>GCSE</p>
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary">2006-2008</span>
            </div>
          </div>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
        <div class="my-auto">
          ...
          <ul class="list-inline list-icons">
            ...
            <li class="list-inline-item">
              <i class="devicons devicons-office"></i>
            </li>
          </ul>
      ...
      <!-- INTRESTS AND ADDITIONAL SKILLS -->
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="CV">
        <div class="my-auto">
          ...
          <a href="img/2019CV.pdf"><img src="img/CV.jpg"></a>
